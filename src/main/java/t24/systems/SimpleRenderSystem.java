...
public class SimpleRenderSystem {
    ...
    public static String vertFilePath = "vulkan/shaders/t24/simple_shader.vert";
    public static String fragFilePath = "vulkan/shaders/t24/simple_shader.frag";
