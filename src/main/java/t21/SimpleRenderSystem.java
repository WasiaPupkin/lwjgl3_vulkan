...
public class SimpleRenderSystem {
    ...
    public static String vertFilePath = "vulkan/shaders/t21/simple_shader.vert";
    public static String fragFilePath = "vulkan/shaders/t21/simple_shader.frag";
...
//        vkDestroyPipeline(lveDevice.getDevice(), lvePipeLine.graphicsPipeline, null);
    ...
    public synchronized void renderGameObjects(LveFrameInfo frameInfo, Vector<LveGameObject> gameObjects) {
        // bind pipline
