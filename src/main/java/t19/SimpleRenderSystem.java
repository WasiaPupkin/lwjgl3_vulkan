...
public class SimpleRenderSystem {
    ...
    public static String vertFilePath = "vulkan/shaders/t18/simple_shader.vert";
    public static String fragFilePath = "vulkan/shaders/t18/simple_shader.frag";
...
//    fixme
    ...
    public void renderGameObjects(LveFrameInfo frameInfo, Vector<LveGameObject> gameObjects){
        // bind pipline
        lvePipeLine.bind(frameInfo.commandBuffer());

        var projectionView = frameInfo.camera().getProjection().mul(frameInfo.camera().getView(), new Matrix4f());

        for(LveGameObject obj : gameObjects) {
            SimplePushConstantData push = new SimplePushConstantData();
            var modelMatrix = obj.transform.mat4();
            push.transform = projectionView.mul(modelMatrix, new Matrix4f());
    ...
    private float[] pushDataToFloatArr(SimplePushConstantData push) {
        return new float[] {push.transform.m00(), push.transform.m01(), push.transform.m02(), push.transform.m03(),
                push.transform.m10(),push.transform.m11(),push.transform.m12(),push.transform.m13(),
                push.transform.m20(),push.transform.m21(),push.transform.m22(),push.transform.m23(),
                push.transform.m30(),push.transform.m31(),push.transform.m32(),push.transform.m33(),
