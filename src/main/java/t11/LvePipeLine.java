...
public class LvePipeLine {
    ...
    public void createGraphicsPipeline(String vertFilePath, String fragFilePath, PipelineConfigInfo configInfo) throws IOException {
        ...
        shaderStages.get(0).set(createShaderModule(lveDevice.getDevice(), vertFilePath, VK_SHADER_STAGE_VERTEX_BIT));
        shaderStages.get(1).set(createShaderModule(lveDevice.getDevice(), fragFilePath, VK_SHADER_STAGE_FRAGMENT_BIT));

        VkPipelineVertexInputStateCreateInfo vertexInputStateCreateInfo = VkPipelineVertexInputStateCreateInfo.calloc()
                .sType$Default()
                .pVertexBindingDescriptions(LveModel.Vertex.getBindingDescriptions())
                .pVertexAttributeDescriptions(LveModel.Vertex.getAttributeDescriptions());
...
//        // Binding description
//        configInfo.bindingDescriptor = VkVertexInputBindingDescription.calloc()
...
//        configInfo.attributeDescriptions = VkVertexInputAttributeDescription.calloc(2);
//        // Location 0 : Position
//        configInfo.attributeDescriptions.get(0)
...
//                .offset(0);
//        // Location 1 : Color
//        configInfo.attributeDescriptions.get(1)
//                .binding(0) // <- binding point used in the VkVertexInputBindingDescription
