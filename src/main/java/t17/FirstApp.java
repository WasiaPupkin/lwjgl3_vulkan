...
//    }
    ...
    private void loadGameObjects() throws IOException {
        LveModel lveModel = LveModel.createModelFromFile(lveDevice, "vulkan/models/cube.obj");
        LveGameObject gameObj  = LveGameObject.createGameObject();
        gameObj .model = lveModel;
        gameObj .transform.translation = new Vector3f(.0f, .0f, 2.5f);
        gameObj .transform.scale = new Vector3f(3.f);
