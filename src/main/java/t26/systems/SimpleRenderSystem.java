...
public class SimpleRenderSystem {
    ...
    public static String vertFilePath = "vulkan/shaders/t26/simple_shader.vert";
    public static String fragFilePath = "vulkan/shaders/t26/simple_shader.frag";
