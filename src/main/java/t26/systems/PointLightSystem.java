...
import t26.GlobalUbo;
import t26.LveDevice;
import t26.LveFrameInfo;
import t26.LvePipeLine;
import t26.PointLight;
import util.VKUtil;
...
public class PointLightSystem {
    ...
    public static String vertFilePath = "vulkan/shaders/t26/point_light.vert";
    public static String fragFilePath = "vulkan/shaders/t26/point_light.frag";
...
//        fixme try to reuse memory
        ...
        for (var obj : frameInfo.gameObjects().values()) {
            ...
            push.position = new Vector4f(obj.transform.translation, 1.f);
            push.color = new Vector4f(obj.color, obj.pointLight.lightIntensity);
