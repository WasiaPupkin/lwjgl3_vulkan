...
public class SimpleRenderSystem {
    public static String vertFilePath = "vulkan/shaders/t13/simple_shader.vert";
    public static String fragFilePath = "vulkan/shaders/t13/simple_shader.frag";
...
//            Vector2f pushOffset = obj.transform.translation;
            ...
            Matrix4f transform = camera.getProjection().mul(obj.transform.mat4(), new Matrix4f());
