...
public class SimpleRenderSystem {
    public static String vertFilePath = "vulkan/shaders/t12/simple_shader_t12.vert";
    public static String fragFilePath = "vulkan/shaders/t12/simple_shader_t12.frag";
...
//            Vector2f pushOffset = obj.transform.translation;
            ...
            Matrix4f transform = obj.transform.mat4();
