...
public class PointLightSystem {
    ...
    public static String vertFilePath = "vulkan/shaders/t25/point_light.vert";
    public static String fragFilePath = "vulkan/shaders/t25/point_light.frag";
